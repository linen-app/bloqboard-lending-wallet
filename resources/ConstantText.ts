...
export const UTILIZE_OTHER_CURRENCIES = 'When set to true, the wallet will use Kyber network to exchange other currencies for the required token. ' +
    'Currently, only WETH is supported.';